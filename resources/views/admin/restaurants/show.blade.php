...
<div class="container mx-auto max-w-screen-xl px-2">
    <div class=" border border-gray-200 rounded-lg shadow bg-gray-50">
        ...
        <div class="p-5">
            ...
            <p class="my-5 font-normal text-gray-700"><span class="text-xl font-bold text-secondary">Indirizzo: </span>{{$restaurant->address}}, {{$restaurant->city}}</p>

            <p class="my-5 font-bold text-gray-700 text-xl"><span class="text-xl font-bold text-secondary">P. IVA: </span>{{$restaurant->vat}}</p> 
