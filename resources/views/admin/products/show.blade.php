...
<a href="{{ route('admin.products.edit', ['product' => $product]) }}"><button data-modal-hide="defaultModal" type="button" class="text-white-500 bg-secondary hover:bg-b_hover focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-secondary-200 text-sm font-medium px-5 py-2.5 hover:text-secondary-900 focus:z-10 dark:bg-secondary-700 dark:text-secondary-300 dark:border-secondary-500 dark:hover:text-white dark:hover:bg-secondary-600 dark:focus:ring-secondary-600">Modifica</button></a>
